...
from zhiliao.core.models import Slugged, Orderable
from zhiliao.conf import settings
from zhiliao.utils.models import get_user_model_name
...
class ThreadedComment(Comment):
    ...
    def avatar_link(self):
        from zhiliao.core.templatetags.mezzanine_tags import gravatar_url
