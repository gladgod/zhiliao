...
from zhiliao.core.forms import Html5Mixin
from .models import Keyword, ThreadedComment, Rating
from zhiliao.utils.cache import add_cache_bypass
from zhiliao.utils.email import split_addresses, send_mail_template
from zhiliao.utils.static import static_lazy as static
from zhiliao.utils.views import ip_for_request
...
class KeywordsWidget(forms.MultiWidget):
    ...
    class Media:
        js = (static("js/zhiliao/keywords_field.js"),)
