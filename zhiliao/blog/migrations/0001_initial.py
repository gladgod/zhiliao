    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_image', zhiliao.core.fields.FileField(max_length=255, null=True, verbose_name='Featured Image', blank=True)),
                ('categories', models.ManyToManyField(related_name='blogposts', verbose_name='Categories', to='blog.BlogCategory', blank=True)),
                ('related_posts', models.ManyToManyField(related_name='_blogpost_related_posts_+', verbose_name='Related posts', to='blog.BlogPost', blank=True)),
                ('site', models.ForeignKey(editable=False, to='sites.Site')),
            ...
            bases=(models.Model, zhiliao.utils.models.AdminThumbMixin),
        ),
    ]
