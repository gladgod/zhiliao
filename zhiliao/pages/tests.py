...
from zhiliao.core.request import current_request
from .models import Page, RichTextPage
from .admin import PageAdminForm
from zhiliao.urls import PAGES_SLUG
from zhiliao.utils.tests import TestCase
...
class PagesTests(TestCase):
    ...
    def test_login_required(self):
        ...
        accounts_installed = ("zhiliao.accounts" in settings.INSTALLED_APPS)
        ...
        if accounts_installed:
            # For an inaccessible page with zhiliao.accounts we should
        ...
        if accounts_installed:
            ...
            with override_settings(LOGIN_URL="zhiliao.accounts.views.login"):
    ...
    def test_unicode_slug_parm_to_processor_for(self):
        ...
        python 2.x
        """
        from .page_processors import processor_for
    ...
    def test_exact_page_processor_for(self):
        ...
        """
        from .middleware import PageMiddleware
        from .page_processors import processor_for
    ...
    def test_page_slug_has_correct_lang(self):
        ...
        from zhiliao.utils.urls import slugify
