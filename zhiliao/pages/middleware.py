...
from zhiliao.pages import context_processors, page_processors
from .models import Page
from .views import page as page_view
from zhiliao.utils.importing import import_dotted_path
from zhiliao.utils.urls import path_to_slug
...
class PageMiddleware(object):
    ...
    def __init__(self):
        if "zhiliao.pages" not in settings.INSTALLED_APPS:
    ...
    def installed(cls):
        ...
        try:
            ...
            name = "zhiliao.pages.middleware.PageMiddleware"
