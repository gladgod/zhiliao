...
from .models import Page, PageMoveException
from zhiliao.utils.urls import home_slug
...
def page(request, slug, template=u"pages/page.html", extra_context=None):
    ...
    from zhiliao.pages.middleware import PageMiddleware
    if not PageMiddleware.installed():
        raise ImproperlyConfigured("zhiliao.pages.middleware.PageMiddleware "
