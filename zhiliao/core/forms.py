...
class TinyMceWidget(forms.Textarea):
    ...
    class Media:
        js = (static("zhiliao/tinymce/tinymce.min.js"),
              static(settings.TINYMCE_SETUP_JS))
        css = {'all': (static("zhiliao/tinymce/tinymce.css"),)}
...
class DynamicInlineAdminForm(forms.ModelForm):
    ...
    class Media:
        js = (static("zhiliao/js/%s" % settings.JQUERY_UI_FILENAME),
              static("zhiliao/js/admin/dynamic_inline.js"),)
