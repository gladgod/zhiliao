...
from .models import Displayable, SitePermission
from zhiliao.utils.cache import add_cache_bypass
from zhiliao.utils.views import is_editable, paginate, render, set_cookie
from zhiliao.utils.sites import has_site_permission
...
def displayable_links_js(request):
    ...
    if "zhiliao.pages" in settings.INSTALLED_APPS:
        from zhiliao.pages.models import Page
