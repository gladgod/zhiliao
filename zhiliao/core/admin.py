...
from zhiliao.core.forms import DynamicInlineAdminForm
from zhiliao.core.models import (Orderable, SitePermission,
    ...
    class BaseTranslationModelAdmin(TranslationAdmin):
        ...
        class Media:
            js = (
                ...
                static("zhiliao/js/%s" % settings.JQUERY_UI_FILENAME),
                static("zhiliao/js/admin/tabbed_translation_fields.js"),
            )
            css = {
                "all": (static(
                    "zhiliao/css/admin/tabbed_translation_fields.css"),),
            }
