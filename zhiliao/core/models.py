...
from .fields import RichTextField, OrderField
from .managers import DisplayableManager, CurrentSiteManager
from zhiliao.generic.fields import KeywordsField
from zhiliao.utils.html import TagCloser
from zhiliao.utils.models import base_concrete_model, get_user_model_name
from zhiliao.utils.sites import current_site_id, current_request
from zhiliao.utils.urls import admin_url, slugify, unique_slug
            ...
            if not description:
                for field in self._meta.fields:
                    if (isinstance(field, field_type) and
                        ...
                        if description:
                            from .templatetags.mezzanine_tags \
