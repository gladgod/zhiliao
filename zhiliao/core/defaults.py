...
if "zhiliao.blog" in settings.INSTALLED_APPS:
    dashboard_tags = (
...
register_setting(
    ...
    description=_("Name of the jQuery file found in "
                  "zhiliao/core/static/zhiliao/js/"),
    editable=False,
...
register_setting(
    ...
    editable=False,
    default="zhiliao.core.forms.TinyMceWidget",
)
...
register_setting(
    ...
    editable=False,
    default=("zhiliao.utils.html.thumbnails",),
)
...
register_setting(
    ...
    default=RICHTEXT_FILTER_LEVEL_NONE,
)
...
register_setting(
    ...
    description=_("Sequence of models that will be provided by default as "
        ...
        "``zhiliao.core.models.Displayable`` should be used."),
    editable=False,
...
register_setting(
    ...
    description=_("Dotted Python path to the callable for converting "
        ...
        "``zhiliao.utils.urls.slugify_unicode`` which allows for non-ascii "
        "URLs. Change to ``django.template.defaultfilters.slugify`` to use "
        "Django's slugify function, or something of your own if required."),
    editable=False,
    default="zhiliao.utils.urls.slugify_unicode",
)
...
register_setting(
    ...
    editable=False,
    default=("zhiliao.utils.views.is_spam_akismet",),
)
...
register_setting(
    ...
    editable=False,
    default="zhiliao/js/tinymce_setup.js",
)
